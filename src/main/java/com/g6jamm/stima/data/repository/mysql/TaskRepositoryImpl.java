    ...
    try {
      ...
      ps.setInt(
          ...
          task.getResourceType()
              .getId()); // TODO: Bug: Cannot add or update a child row: a foreign key constraint
                         // fails (`stima`.`tasks`, CONSTRAINT `FKtasks862162` FOREIGN KEY
                         // (`resource_type_id`) REFERENCES `resource_types` (`resource_type_id`))
